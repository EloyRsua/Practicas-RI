...
public class Associations {
	...
	public static class Binds {
		...
		static void unlink(Contract contract) {
	...
	// CONTRACT PROFESIONALGROUP
	public static class Categorizes {
		static void link(Contract contract, ProfessionalGroup prof) {
			contract._setProfessionalGroup(prof);
			prof._getContracts()
				.add(contract);
		}

		static void unlink(Contract contract) {
			ProfessionalGroup prof = contract.getProfessionalGroup();
			prof._getContracts()
				.remove(contract);
	...
	public static class Defines {
		static void link(Contract contract, ContractType type) {
	...
	public static class Generates {
		static void link(Contract contract, Payroll payroll) {
			contract._getPayrolls()
				.add(payroll);
			payroll._setContract(contract);
		}

		static void unlink(Payroll payroll) {
			Contract contract = payroll.getContract();
