...
public class DtoAssembler {
	...
	public static ContractDto toDto(Contract arg) {
		...
		result.contractType.id = arg.getContractType()
			.getId();
		result.contractType.name = arg.getContractType()
			.getName();
		result.contractType.compensationDaysPerYear = arg.getContractType()
			.getCompensationDaysPerYear();

		result.professionalGroup.id = arg.getProfessionalGroup()
			.getId();
		result.professionalGroup.name = arg.getProfessionalGroup()
			.getName();
		...
		result.mechanic.id = arg.getMechanic()
			.getId();
		result.mechanic.nif = arg.getMechanic()
			.getNif();
		result.mechanic.name = arg.getMechanic()
			.getName();
		result.mechanic.surname = arg.getMechanic()
			.getSurname();
