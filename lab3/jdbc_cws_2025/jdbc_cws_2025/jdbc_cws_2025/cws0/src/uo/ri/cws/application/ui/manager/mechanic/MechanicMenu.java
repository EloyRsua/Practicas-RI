...
import uo.ri.cws.application.ui.manager.mechanic.action.ListMechanicsWithActiveContractsAction;
...
public class MechanicMenu extends BaseMenu {
	...
	menuOptions = new Object[][] {
	    ...
	    { "List mechanics with active contracts",
		ListMechanicsWithActiveContractsAction.class }, };
    }
