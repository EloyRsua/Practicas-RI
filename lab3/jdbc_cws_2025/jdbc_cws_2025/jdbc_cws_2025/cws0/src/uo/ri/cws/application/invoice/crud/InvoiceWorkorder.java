...
public class InvoiceWorkorder {
    ...
    private static final String TINVOICES_ADD = "INSERT INTO TInvoices(id, number, date, vat, amount, state, version) "
	+ "VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    private static final String TWORKORDERS_UPDATE_TIME_VERSION = "update TWorkOrders set updatedAt = ? where id = ?";
...
//	    displayInvoice(numberInvoice, dateInvoice, amount, vat, total);
	...
	try (PreparedStatement pst = c.prepareStatement(
	    TWORKORDERS_UPDATE_TIME_VERSION)) {
