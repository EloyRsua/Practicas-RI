...
import uo.ri.cws.application.mechanic.crud.commands.AddMechanic;
import uo.ri.cws.application.mechanic.crud.commands.DeleteMechanic;
import uo.ri.cws.application.mechanic.crud.commands.FindAllMechanics;
import uo.ri.cws.application.mechanic.crud.commands.FindMechanicByNif;
import uo.ri.cws.application.mechanic.crud.commands.UpdateMechanic;
import uo.ri.cws.application.mechanic.crud.commands.FindMechanicById;
...
public class MechanicCrudServiceImpl implements MechanicCrudService {
	...
	FindMechanicById fbi = new FindMechanicById(id);
	return fbi.execute();
    }
